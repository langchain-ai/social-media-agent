...
export const CurateDataConfigurableAnnotation = Annotation.Root({
  ...
  /**
   * X search query for the optional Xquik source.
   */
  [XQUIK_SEARCH_QUERY]: Annotation<string | undefined>(),
  /**
   * X search result limit for the optional Xquik source.
   */
  [XQUIK_SEARCH_LIMIT]: Annotation<number | undefined>(),
